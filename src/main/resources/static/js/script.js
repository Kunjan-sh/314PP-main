...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const tabContentUsersList = document.getElementById('tab-users-list-content');
    tabUsersList.classList.add('active');
    tabUsersList.setAttribute('aria-selected', 'true');
    tabContentUsersList.classList.add('show', 'active');
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    adminLink.addEventListener('click', updateActiveLink);
    userLink.addEventListener('click', updateActiveLink);
});
